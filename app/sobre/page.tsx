...
export const metadata: Metadata = {
  ...
  description: "Conheça o estúdio Sadina Santos e o cuidado por trás de cada atendimento.",
};
      ...
      <section className="pt-32 pb-6 md:pt-40">
        <Container className="max-w-2xl">
          ...
          <h1 className="font-display text-4xl leading-tight text-[var(--color-ink)] md:text-5xl">
            {/* TODO: ajustar com a história real de Sadina Santos */}
            A cadeira onde a técnica encontra a escuta
          </h1>
        </Container>
      </section>
